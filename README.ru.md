...
**Работает с любым JWT-провайдером на основе HS256** — Strapi, собственный auth-сервер и т.д. Задайте `JWT_SECRET` равным секрету, который использует ваш провайдер.
